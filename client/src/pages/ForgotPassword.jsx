        ...
        {!submitted ? (
          <>
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
              Remembered it?   
              <Link to="/login" className="text-[#2563EB] font-semibold hover:text-blue-700 transition ml-1">
                Back to sign in
              </Link>
            </p>
          </>
          ...
          >
            ...
            <Link
              to="/login"
              className="mt-8 inline-block w-full rounded-xl bg-[#2563EB] py-3.5 text-center font-semibold text-white hover:bg-blue-700 transition duration-200"
            >
              Back to Sign In
            </Link>
          </motion.div>
